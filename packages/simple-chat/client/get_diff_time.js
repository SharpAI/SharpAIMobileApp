...
function getTimeStr(dateTimeStamp){
    ...
    if(isToday(dateTimeStamp)){
        return moment(dateTimeStamp).locale('en').format("hh:mm A");
    }else if(isYesterday(dateTimeStamp)){
        return moment(dateTimeStamp).locale('en').format("hh:mm A");
    }else if(isWithinAweek(dateTimeStamp)){
        return moment(dateTimeStamp).locale('en').format('ddd hh:mm A');
    }else if(isCurYear(dateTimeStamp)){
        return moment(dateTimeStamp).locale('en').format('MMMD hh:mm A');
    }else {
        return moment(dateTimeStamp).locale('en').format('ll hh:mm A');
    }
